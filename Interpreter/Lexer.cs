...
namespace MTRAN.Interpreter
{
    ...
    public class PerlLexerParser
    {
        ...
        public Dictionary<MTRAN.Interpreter.PerlToken, List<(int line, int column)>> tokenBuffer = new Dictionary<MTRAN.Interpreter.PerlToken, List<(int line, int column)>>();
